...
# %% auto 0
__all__ = ['BB_CLASS_NAMES', 'class_dicts', 'BB_CLASSES', 'BuildingBlockSchema', 'BuildingBlockClass', 'ReactionUniverse',
           'BuildingBlock']
...
class_dicts = [json.load(open(f'building_block_schemas/{i}.json')) for i in BB_CLASS_NAMES]

BB_CLASSES = [BuildingBlockClass.from_dict(i) for i in class_dicts]
BB_CLASSES = {i.name : i for i in BB_CLASSES}
